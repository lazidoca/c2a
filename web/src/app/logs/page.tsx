...
const typeLabels: Record<string, string> = {
  ...
  [LogType.Account]: "Account Management Logs",
};
    ...
    <section className="space-y-5">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div className="space-y-1">
          ...
          <h1 className="text-2xl font-semibold tracking-tight">Log Manager</h1>
        </div>
        <div className="flex flex-wrap gap-2">
          <Select value={type} onValueChange={setType}>
            ...
            <SelectContent>
              ...
              <SelectItem value={LogType.Account}>Account Management Logs</SelectItem>
            </SelectContent>
          </Select>
        ...
        <CardContent className="p-0">
          <div className="flex flex-wrap items-center justify-between gap-3 border-b border-stone-100 px-5 py-4">
            <div className="flex flex-wrap items-center gap-3 text-sm text-stone-600">
              ...
              {selectedIds.length > 0 ? <span>Selected {selectedIds.length} records</span> : null}
            </div>
          ...
          <div className="flex items-center justify-end gap-2 border-t border-stone-100 px-4 py-3 text-sm text-stone-500">
            <span>Page {safePage} / {pageCount}, Total {items.length} records</span>
        ...
        <DialogContent showCloseButton={false} className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            ...
            <DialogDescription className="text-sm leading-6">
              Are you sure you want to delete {deletingItems.length} logs? This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
