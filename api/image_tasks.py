...
def create_router() -> APIRouter:
    ...
    async def create_generation_task(
        ...
        identity = require_identity(authorization)
        await filter_or_log(LoggedCall(identity, "/api/image-tasks/generations", body.model, "Nhiệm vụ văn bản sang hình ảnh", request_text=body.prompt), body.prompt)
        try:
    ...
    async def create_edit_task(
        ...
        await filter_or_log(LoggedCall(identity, "/api/image-tasks/edits", model, "Nhiệm vụ hình ảnh sang hình ảnh", request_text=prompt), prompt)
