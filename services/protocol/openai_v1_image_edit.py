...
def _composite_mask(
    ...
    """Composites the alpha channel of the mask into the image to identify the area to edit.
    
    Transparent area of the mask (low alpha) = area to edit.
    Opaque area of the mask (high alpha) = area to retain.
    If no mask is provided, returns the original image.
    """
    if not masks:
        return images
